# Save and convert as PDF - Improved Version

> **Note**: Ce projet est une version améliorée du projet original [PnP Save and convert as PDF](https://github.com/pnp/sp-dev-fx-extensions/tree/main/samples/react-command-convert-to-pdf). Il a été repris et enrichi avec plusieurs améliorations notables, notamment au niveau de l'UX, de la détection automatique des extensions de fichiers, et d'autres modifications. D'autres améliorations sont prévues à venir.

> **Note**: This project is an improved version of the original [PnP Save and convert as PDF](https://github.com/pnp/sp-dev-fx-extensions/tree/main/samples/react-command-convert-to-pdf) project. It has been taken over and enhanced with several notable improvements, particularly in terms of UX, automatic file extension detection, and other modifications. More improvements are planned to come.
...
## Improvements over the original PnP version

### 🎨 Enhanced User Experience (UX)
- Improved progress indicators and visual feedback
- Better error handling and user notifications
- Enhanced dialog interfaces for better usability
- Streamlined workflow for batch operations

### 🔍 Automatic File Extension Detection
- Smart detection of file extensions directly from selected files
- Automatic filtering of unsupported file types
- Improved validation before processing
...
### 📋 Coming Soon
- Additional improvements and features are planned
...
Solution|Author(s)
--------|---------
pnp-ext-pdf-convert (Improved Version)| Based on original by Mikael Svenson ([@mikaelsvenson](https://twitter.com/mikaelsvenson)) - Enhanced and improved version
